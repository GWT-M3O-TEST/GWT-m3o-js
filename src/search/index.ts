...
createIndex(request: CreateIndexRequest): Promise<CreateIndexResponse> {
		return this.client.call("search", "CreateIndex", request) as Promise<CreateIndexResponse>;
	};
	// Delete an index by name
deleteIndex(request: DeleteIndexRequest): Promise<DeleteIndexResponse> {
		return this.client.call("search", "DeleteIndex", request) as Promise<DeleteIndexResponse>;
	};
	// Delete a record given its ID
delete(request: DeleteRequest): Promise<DeleteResponse> {
		return this.client.call("search", "Delete", request) as Promise<DeleteResponse>;
	};
	// Index a record i.e. insert a document to search for.
index(request: IndexRequest): Promise<IndexResponse> {
		return this.client.call("search", "Index", request) as Promise<IndexResponse>;
	};
	// Search for records in a given in index
search(request: SearchRequest): Promise<SearchResponse> {
		return this.client.call("search", "Search", request) as Promise<SearchResponse>;
	};
