...
lookup(request: LookupRequest): Promise<LookupResponse> {
		return this.client.call("postcode", "Lookup", request) as Promise<LookupResponse>;
	};
	// Return a random postcode and its related info
random(request: RandomRequest): Promise<RandomResponse> {
		return this.client.call("postcode", "Random", request) as Promise<RandomResponse>;
	};
	// Validate a postcode.
validate(request: ValidateRequest): Promise<ValidateResponse> {
		return this.client.call("postcode", "Validate", request) as Promise<ValidateResponse>;
	};
