...
directions(request: DirectionsRequest): Promise<DirectionsResponse> {
		return this.client.call("routing", "Directions", request) as Promise<DirectionsResponse>;
	};
...
route(request: RouteRequest): Promise<RouteResponse> {
		return this.client.call("routing", "Route", request) as Promise<RouteResponse>;
	};
