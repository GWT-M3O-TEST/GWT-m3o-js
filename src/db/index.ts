...
dropTable(request: DropTableRequest): Promise<DropTableResponse> {
		return this.client.call("db", "DropTable", request) as Promise<DropTableResponse>;
	};
	// List tables in the DB
listTables(request: ListTablesRequest): Promise<ListTablesResponse> {
		return this.client.call("db", "ListTables", request) as Promise<ListTablesResponse>;
	};
...
renameTable(request: RenameTableRequest): Promise<RenameTableResponse> {
		return this.client.call("db", "RenameTable", request) as Promise<RenameTableResponse>;
	};
	// Truncate the records in a table
truncate(request: TruncateRequest): Promise<TruncateResponse> {
		return this.client.call("db", "Truncate", request) as Promise<TruncateResponse>;
	};
