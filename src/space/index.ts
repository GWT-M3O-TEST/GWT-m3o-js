...
create(request: CreateRequest): Promise<CreateResponse> {
		return this.client.call("space", "Create", request) as Promise<CreateResponse>;
	};
	// Delete an object from space
delete(request: DeleteRequest): Promise<DeleteResponse> {
		return this.client.call("space", "Delete", request) as Promise<DeleteResponse>;
	};
	// Download an object via a presigned url
download(request: DownloadRequest): Promise<DownloadResponse> {
		return this.client.call("space", "Download", request) as Promise<DownloadResponse>;
	};
...
update(request: UpdateRequest): Promise<UpdateResponse> {
		return this.client.call("space", "Update", request) as Promise<UpdateResponse>;
	};
	// Upload a large object (> 10MB). Returns a time limited presigned URL to be used for uploading the object
upload(request: UploadRequest): Promise<UploadResponse> {
		return this.client.call("space", "Upload", request) as Promise<UploadResponse>;
	};
