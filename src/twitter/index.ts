...
search(request: SearchRequest): Promise<SearchResponse> {
		return this.client.call("twitter", "Search", request) as Promise<SearchResponse>;
	};
	// Get the timeline for a given user
timeline(request: TimelineRequest): Promise<TimelineResponse> {
		return this.client.call("twitter", "Timeline", request) as Promise<TimelineResponse>;
	};
	// Get the current global trending topics
trends(request: TrendsRequest): Promise<TrendsResponse> {
		return this.client.call("twitter", "Trends", request) as Promise<TrendsResponse>;
	};
	// Get a user's twitter profile
user(request: UserRequest): Promise<UserResponse> {
		return this.client.call("twitter", "User", request) as Promise<UserResponse>;
	};
