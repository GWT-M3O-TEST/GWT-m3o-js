...
call(request: CallRequest): Promise<CallResponse> {
		return this.client.call("function", "Call", request) as Promise<CallResponse>;
	};
	// Delete a function by name
delete(request: DeleteRequest): Promise<DeleteResponse> {
		return this.client.call("function", "Delete", request) as Promise<DeleteResponse>;
	};
	// Deploy a group of functions
deploy(request: DeployRequest): Promise<DeployResponse> {
		return this.client.call("function", "Deploy", request) as Promise<DeployResponse>;
	};
	// Get the info for a deployed function
describe(request: DescribeRequest): Promise<DescribeResponse> {
		return this.client.call("function", "Describe", request) as Promise<DescribeResponse>;
	};
	// List all the deployed functions
list(request: ListRequest): Promise<ListResponse> {
		return this.client.call("function", "List", request) as Promise<ListResponse>;
	};
	// Get the logs for a function
logs(request: LogsRequest): Promise<LogsResponse> {
		return this.client.call("function", "Logs", request) as Promise<LogsResponse>;
	};
	// Return the backend url for proxying
proxy(request: ProxyRequest): Promise<ProxyResponse> {
		return this.client.call("function", "Proxy", request) as Promise<ProxyResponse>;
	};
	// Return a list of supported regions
regions(request: RegionsRequest): Promise<RegionsResponse> {
		return this.client.call("function", "Regions", request) as Promise<RegionsResponse>;
	};
	// Reserve function names and resources beyond free quota
reserve(request: ReserveRequest): Promise<ReserveResponse> {
		return this.client.call("function", "Reserve", request) as Promise<ReserveResponse>;
	};
	// Return a list of supported runtimes
runtimes(request: RuntimesRequest): Promise<RuntimesResponse> {
		return this.client.call("function", "Runtimes", request) as Promise<RuntimesResponse>;
	};
	// Update a function. Downloads the source, builds and redeploys
update(request: UpdateRequest): Promise<UpdateResponse> {
		return this.client.call("function", "Update", request) as Promise<UpdateResponse>;
	};
