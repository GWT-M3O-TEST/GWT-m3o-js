...
create(request: CreateRequest): Promise<CreateResponse> {
		return this.client.call("lists", "Create", request) as Promise<CreateResponse>;
	};
	// Delete a list
delete(request: DeleteRequest): Promise<DeleteResponse> {
		return this.client.call("lists", "Delete", request) as Promise<DeleteResponse>;
	};
...
update(request: UpdateRequest): Promise<UpdateResponse> {
		return this.client.call("lists", "Update", request) as Promise<UpdateResponse>;
	};
