...
create(request: CreateRequest): Promise<CreateResponse> {
		return this.client.call("user", "Create", request) as Promise<CreateResponse>;
	};
	// Delete an account by id
delete(request: DeleteRequest): Promise<DeleteResponse> {
		return this.client.call("user", "Delete", request) as Promise<DeleteResponse>;
	};
...
logoutAll(request: LogoutAllRequest): Promise<LogoutAllResponse> {
		return this.client.call("user", "LogoutAll", request) as Promise<LogoutAllResponse>;
	};
	// Logout a user account
logout(request: LogoutRequest): Promise<LogoutResponse> {
		return this.client.call("user", "Logout", request) as Promise<LogoutResponse>;
	};
...
readSession(request: ReadSessionRequest): Promise<ReadSessionResponse> {
		return this.client.call("user", "ReadSession", request) as Promise<ReadSessionResponse>;
	};
	// Reset password with the code sent by the "SendPasswordResetEmail" endpoint.
resetPassword(request: ResetPasswordRequest): Promise<ResetPasswordResponse> {
		return this.client.call("user", "ResetPassword", request) as Promise<ResetPasswordResponse>;
	};
	// Login using email only - Passwordless
sendMagicLink(request: SendMagicLinkRequest): Promise<SendMagicLinkResponse> {
		return this.client.call("user", "SendMagicLink", request) as Promise<SendMagicLinkResponse>;
	};
...
sendPasswordResetEmail(request: SendPasswordResetEmailRequest): Promise<SendPasswordResetEmailResponse> {
		return this.client.call("user", "SendPasswordResetEmail", request) as Promise<SendPasswordResetEmailResponse>;
	};
	// Send a verification email to a user.
sendVerificationEmail(request: SendVerificationEmailRequest): Promise<SendVerificationEmailResponse> {
		return this.client.call("user", "SendVerificationEmail", request) as Promise<SendVerificationEmailResponse>;
	};
	// Update the account password
updatePassword(request: UpdatePasswordRequest): Promise<UpdatePasswordResponse> {
		return this.client.call("user", "UpdatePassword", request) as Promise<UpdatePasswordResponse>;
	};
	// Update the account username or email
update(request: UpdateRequest): Promise<UpdateResponse> {
		return this.client.call("user", "Update", request) as Promise<UpdateResponse>;
	};
	// Verify the email address of an account from a token sent in an email to the user.
verifyEmail(request: VerifyEmailRequest): Promise<VerifyEmailResponse> {
		return this.client.call("user", "VerifyEmail", request) as Promise<VerifyEmailResponse>;
	};
...
verifyToken(request: VerifyTokenRequest): Promise<VerifyTokenResponse> {
		return this.client.call("user", "VerifyToken", request) as Promise<VerifyTokenResponse>;
	};
