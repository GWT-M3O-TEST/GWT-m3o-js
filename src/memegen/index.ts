...
generate(request: GenerateRequest): Promise<GenerateResponse> {
		return this.client.call("memegen", "Generate", request) as Promise<GenerateResponse>;
	};
	// List the available templates
templates(request: TemplatesRequest): Promise<TemplatesResponse> {
		return this.client.call("memegen", "Templates", request) as Promise<TemplatesResponse>;
	};
