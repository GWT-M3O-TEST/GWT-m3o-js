...
convert(request: ConvertRequest): Promise<ConvertResponse> {
		return this.client.call("image", "Convert", request) as Promise<ConvertResponse>;
	};
	// Delete an image previously uploaded.
delete(request: DeleteRequest): Promise<DeleteResponse> {
		return this.client.call("image", "Delete", request) as Promise<DeleteResponse>;
	};
...
resize(request: ResizeRequest): Promise<ResizeResponse> {
		return this.client.call("image", "Resize", request) as Promise<ResizeResponse>;
	};
...
upload(request: UploadRequest): Promise<UploadResponse> {
		return this.client.call("image", "Upload", request) as Promise<UploadResponse>;
	};
