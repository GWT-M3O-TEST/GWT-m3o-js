...
books(request: BooksRequest): Promise<BooksResponse> {
		return this.client.call("sunnah", "Books", request) as Promise<BooksResponse>;
	};
	// Get all the chapters of a given book within a collection.
chapters(request: ChaptersRequest): Promise<ChaptersResponse> {
		return this.client.call("sunnah", "Chapters", request) as Promise<ChaptersResponse>;
	};
	// Get a list of available collections. A collection is
// a compilation of hadiths collected and written by an author.
collections(request: CollectionsRequest): Promise<CollectionsResponse> {
		return this.client.call("sunnah", "Collections", request) as Promise<CollectionsResponse>;
	};
	// Hadiths returns a list of hadiths and their corresponding text for a
// given book within a collection.
hadiths(request: HadithsRequest): Promise<HadithsResponse> {
		return this.client.call("sunnah", "Hadiths", request) as Promise<HadithsResponse>;
	};
