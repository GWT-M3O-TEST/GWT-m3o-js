...
delete(request: DeleteRequest): Promise<DeleteResponse> {
		return this.client.call("app", "Delete", request) as Promise<DeleteResponse>;
	};
	// List all the apps
...
regions(request: RegionsRequest): Promise<RegionsResponse> {
		return this.client.call("app", "Regions", request) as Promise<RegionsResponse>;
	};
	// Reserve apps beyond the free quota. Call Run after.
reserve(request: ReserveRequest): Promise<ReserveResponse> {
		return this.client.call("app", "Reserve", request) as Promise<ReserveResponse>;
	};
	// Resolve an app by id to its raw backend endpoint
resolve(request: ResolveRequest): Promise<ResolveResponse> {
		return this.client.call("app", "Resolve", request) as Promise<ResolveResponse>;
	};
...
status(request: StatusRequest): Promise<StatusResponse> {
		return this.client.call("app", "Status", request) as Promise<StatusResponse>;
	};
	// Update the app. The latest source code will be downloaded, built and deployed.
update(request: UpdateRequest): Promise<UpdateResponse> {
		return this.client.call("app", "Update", request) as Promise<UpdateResponse>;
	};
