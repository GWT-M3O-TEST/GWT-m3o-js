...
create(request: CreateRequest): Promise<CreateResponse> {
		return this.client.call("comments", "Create", request) as Promise<CreateResponse>;
	};
	// Delete a comment
delete(request: DeleteRequest): Promise<DeleteResponse> {
		return this.client.call("comments", "Delete", request) as Promise<DeleteResponse>;
	};
...
list(request: ListRequest): Promise<ListResponse> {
		return this.client.call("comments", "List", request) as Promise<ListResponse>;
	};
	// Read a comment
read(request: ReadRequest): Promise<ReadResponse> {
		return this.client.call("comments", "Read", request) as Promise<ReadResponse>;
	};
	// Update a comment
update(request: UpdateRequest): Promise<UpdateResponse> {
		return this.client.call("comments", "Update", request) as Promise<UpdateResponse>;
	};
