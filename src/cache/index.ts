...
decrement(request: DecrementRequest): Promise<DecrementResponse> {
		return this.client.call("cache", "Decrement", request) as Promise<DecrementResponse>;
	};
	// Delete a value from the cache. If key not found a success response is returned.
delete(request: DeleteRequest): Promise<DeleteResponse> {
		return this.client.call("cache", "Delete", request) as Promise<DeleteResponse>;
	};
...
increment(request: IncrementRequest): Promise<IncrementResponse> {
		return this.client.call("cache", "Increment", request) as Promise<IncrementResponse>;
	};
	// List all the available keys
listKeys(request: ListKeysRequest): Promise<ListKeysResponse> {
		return this.client.call("cache", "ListKeys", request) as Promise<ListKeysResponse>;
	};
