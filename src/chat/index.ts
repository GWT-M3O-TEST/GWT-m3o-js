...
create(request: CreateRequest): Promise<CreateResponse> {
		return this.client.call("chat", "Create", request) as Promise<CreateResponse>;
	};
	// Delete a chat room
delete(request: DeleteRequest): Promise<DeleteResponse> {
		return this.client.call("chat", "Delete", request) as Promise<DeleteResponse>;
	};
	// List the messages in a chat
history(request: HistoryRequest): Promise<HistoryResponse> {
		return this.client.call("chat", "History", request) as Promise<HistoryResponse>;
	};
	// Invite a user to a chat room
invite(request: InviteRequest): Promise<InviteResponse> {
		return this.client.call("chat", "Invite", request) as Promise<InviteResponse>;
	};
	// Join a chat room
